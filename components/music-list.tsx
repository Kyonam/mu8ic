        ...
        <div className="flex flex-col space-y-6 w-full max-w-4xl pb-44">
            ...
            <div className="relative w-full group mb-4">
                ...
                <input
                    ...
                    className="h-12 w-full rounded-2xl border border-white/10 bg-white/[0.03] pl-10 pr-4 text-xs font-medium text-white placeholder-white/20 outline-none transition-all focus:bg-white/[0.06] focus:border-white/20 backdrop-blur-xl shadow-2xl transition-all"
                />
            </div>

            {completedTracks.length === 0 && !isGenerating && !error ? (
                <motion.div
                ...
                >
                    ...
                    <p className="mt-4 text-[10px] uppercase tracking-[0.3em] text-white/10 select-none">
                        {tracks.length > 0 ? "No results found for your search" : "Ready to generate your next soundtrack"}
                    </p>
                </motion.div>
            ) : (
                <>
